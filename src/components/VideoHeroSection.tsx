...
const VideoHeroSection: React.FC = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Multi-Source Video Background for Maximum Compatibility */}
      {!isMobile && videoStatus !== 'fallback' && (
        ...
        >
          ...
          <source src="/videos/video-1749337159021.mp4" type="video/mp4" />
      ...
      {(isMobile || videoStatus === 'fallback' || videoStatus === 'error') && (
        <div 
          className="absolute top-0 left-0 w-full h-full bg-cover bg-center z-0 transition-all duration-1000"
          style={{
      ...
      {videoStatus === 'loading' && !isMobile && (
        <div className="absolute top-0 left-0 w-full h-full bg-black z-5 flex items-center justify-center">
